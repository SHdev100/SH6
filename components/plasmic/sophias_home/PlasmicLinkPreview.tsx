...
import sty from "./PlasmicLinkPreview.module.css"; // plasmic-import: EA8sEmKdiXm4/css
...
function PlasmicLinkPreview__RenderFunc(props: {
  ...
  return (
    ...
    >
      <DataCtxReader__>
        {$ctx => (
          <div className={classNames(projectcss.all, sty.freeBox__beu82)}>
            <PlasmicImg__
            ...
            <div className={classNames(projectcss.all, sty.freeBox___8Xoha)}>
              <div className={classNames(projectcss.all, sty.freeBox___6Zpe)}>
                <h5
