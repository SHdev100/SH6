...
import sty from "./PlasmicGames.module.css"; // plasmic-import: 3Kg70Hg1Zzn1/css

createPlasmicElementProxy;

export type PlasmicGames__VariantMembers = {};
export type PlasmicGames__VariantsArgs = {};
type VariantPropType = keyof PlasmicGames__VariantsArgs;
export const PlasmicGames__VariantProps = new Array<VariantPropType>();

export type PlasmicGames__ArgsType = {};
type ArgPropType = keyof PlasmicGames__ArgsType;
export const PlasmicGames__ArgProps = new Array<ArgPropType>();

export type PlasmicGames__OverridesType = {
  root?: Flex__<"div">;
...
export interface DefaultGamesProps {}
...
function PlasmicGames__RenderFunc(props: {
  variants: PlasmicGames__VariantsArgs;
  args: PlasmicGames__ArgsType;
  overrides: PlasmicGames__OverridesType;
  forNode?: string;
}) {
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">{PlasmicGames.pageMetadata.title}</title>
        <meta
          key="og:title"
          property="og:title"
          content={PlasmicGames.pageMetadata.title}
        />
        <meta
          key="twitter:title"
          name="twitter:title"
      ...
      >
        ...
        >
          <PlasmicImg__
            alt={""}
            className={classNames(sty.img__sKy6Q)}
            displayHeight={"256px"}
          ...
          <PlasmicImg__
            alt={""}
            className={classNames(sty.img__vyab3)}
            displayHeight={"256px"}
            displayMaxHeight={"none"}
            displayMaxWidth={"100%"}
            displayMinHeight={"0"}
          ...
          <PlasmicImg__
            alt={""}
            className={classNames(sty.img__qh7Yj)}
            displayHeight={"256px"}
            displayMaxHeight={"none"}
            displayMaxWidth={"100%"}
            displayMinHeight={"0"}
...
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicGames__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    // Specify args directly as props
    Omit<PlasmicGames__ArgsType, ReservedPropsType> &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicGames__ArgProps,
          internalVariantPropNames: PlasmicGames__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicGames__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicGames";
  } else {
    func.displayName = `PlasmicGames.${nodeName}`;
  }
  return func;
}

export const PlasmicGames = Object.assign(
  // Top-level PlasmicGames renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicGames
    internalVariantProps: PlasmicGames__VariantProps,
    internalArgProps: PlasmicGames__ArgProps,
